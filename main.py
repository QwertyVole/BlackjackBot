...
def main():
    ...
    while True:
        ...
        if not round_in_progress and u.check_message(screenshot, u.place_bets_coords, "PLACE YOUR BETS"):
            ...
            previous_message = "PLACE YOUR BETS"
            print("Start of a new round detected")
            u.click_position(u.betting_unit_coords)
            u.click_position(u.betting_position_coords)
            round_in_progress = True
        elif u.check_message(screenshot, u.make_decision_coords, "DEALING"):
            previous_message = "DEALING"
        elif u.check_message(screenshot, u.make_decision_coords, "MAKE YOUR DECISION"):
        ...
        if round_in_progress == True and previous_message != "PLACE YOUR BETS" and u.check_message(screenshot, u.place_bets_coords, "PLACE YOUR BETS"):
            print("End of round")
            break
